// Script note: Controls menu flow for starting, continuing, difficulty selection, records, and practice entry.
// Comment pass: documents responsibilities and key entry points without changing runtime logic.
using UnityEngine;
using UnityEngine.SceneManagement;
using UnityEngine.UI;

// Class responsibility: SceneFlowManager contains this script's gameplay behavior.
public class SceneFlowManager : MonoBehaviour
{
    ...
    // Handles the ReloadCurrentScene logic.
    public void ReloadCurrentScene()
    {
        SceneManager.LoadScene(SceneManager.GetActiveScene().name);
    }

    // Handles the SetEasyDifficulty logic.
    public void SetEasyDifficulty()
    {
        SetDifficulty(0);
    }

    // Handles the SetNormalDifficulty logic.
    public void SetNormalDifficulty()
    {
        SetDifficulty(1);
    }

    // Handles the SetHardDifficulty logic.
    public void SetHardDifficulty()
    {
        SetDifficulty(2);
    }

    // Handles the SetDifficulty logic.
    ...
    // Handles the BuildDifficultyUI logic.
    ...
    // Handles the StartMainGame logic.
    ...
    // Handles the UpdateDifficultyUI logic.
    ...
    // Handles the SetButtonColor logic.
