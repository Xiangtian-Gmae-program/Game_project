// Script note: Experimental player controller with CharacterController movement, combo, defense, and jump assist logic.
// Comment pass: documents responsibilities and key entry points without changing runtime logic.
using UnityEngine;
using System.Collections;

[RequireComponent(typeof(CharacterController))]
// Class responsibility: TestPlayerController contains this script's gameplay behavior.
public class TestPlayerController : MonoBehaviour
{
    ...
    // Returns movement speed multiplier based on input direction.
    ...
    // Updates movement blend values from planar velocity.
    ...
    // Handles planar movement in the experimental controller.
    void HandleMovement()
    {
    ...
    // Handles attack, defense, and jump input in the experimental controller.
    ...
    // Handles gravity and grounded state in the experimental controller.
    ...
    // Locks player action input for a short duration.
    ...
    // Updates the current action-lock timer.
    ...
    // Runs combo timing and input window logic.
    ...
    // Plays the requested combo animation step.
    ...
    // Consumes buffered jump input when conditions allow.
